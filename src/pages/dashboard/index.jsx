  ...
  return (
    <main className="bg-cyan-800 min-h-screen w-full flex">
      <nav className="flex flex-col h-screen gap-5 p-5 overflow-y-auto">
        ...
        <NavLink className={`font-bold text-white/20`}>Overview</NavLink>
        <div className="flex flex-col gap-2">
          <p className="text-white/15 border-gray-400/30 text-xs border-b">
            Transactions
          </p>
          <NavLink className={`font-bold text-white/20`}>Delivery</NavLink>
          ...
          <NavLink className={`font-bold text-white/20`}>
            Create Transaction
          </NavLink>
        </div>
        <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <NavLink className={`font-bold text-white/20`}>Products</NavLink>
        ...
        <div className="flex flex-col gap-2 mt-auto">
          ...
          <button className={`font-bold text-white/20 text-xs`}>Logout</button>
        </div>
      </nav>
